...
window.addRecord = async function () {
    ...
    <div class="modal-body">
        <div class="detail-grid-top">
            <div>
                <div class="info-box">
                    ...
                    <ul>
                        <li>
                            <strong>Enter Unique Role Name</strong>. 
                            The system will prevent duplicates (e.g., 'Meter Reader' or 'Billing Clerk').
                        </li>
                        <li>
                            <strong>Assign Permissions</strong>:
                            Selected permissions will define what pages the user can access.
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div>
                <div class="detail-item">
                    ...
                    <input class="detail-value detail-input" id="role_name" placeholder="e.g. Finance Manager">
                </div>
                
                <div class="detail-item" style="margin-top: 20px;">
                    <span class="detail-label">Assign Permissions</span>
                    <div id="permissions_container" style="max-height: 200px; overflow-y: auto; border: 1px solid var(--border-color); border-radius: 4px; padding: 10px; margin-top: 5px;">
                        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                            <input type="checkbox" class="perm-check" value="1" id="p1" style="width: 16px; height: 16px;"> 
                            <label for="p1" style="font-size: 13px; cursor: pointer;">VIEW_BILLING</label>
                        </div>
                        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                            <input type="checkbox" class="perm-check" value="2" id="p2" style="width: 16px; height: 16px;"> 
                            <label for="p2" style="font-size: 13px; cursor: pointer;">EDIT_TARIFF</label>
                        </div>
                        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                            <input type="checkbox" class="perm-check" value="3" id="p3" style="width: 16px; height: 16px;"> 
                            <label for="p3" style="font-size: 13px; cursor: pointer;">MANAGE_USERS</label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="detail-grid-bottom">
            <div></div>
            <button class="btn-adv btn-save" onclick="saveNewRole()">Save</button>
        </div>
    </div>
`;
